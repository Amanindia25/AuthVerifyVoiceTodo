...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-50 text-center p-6 sm:p-8 lg:p-12">
      <h1 className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 leading-tight mb-6 animate-fade-in-down">
        Welcome to AuthVerifyVoiceTodo!
      </h1>
      <p className="text-lg sm:text-xl text-gray-700 max-w-3xl mb-10 leading-relaxed animate-fade-in-up">
      ...
      <div className="w-full max-w-xs sm:max-w-sm lg:max-w-md space-y-5 animate-fade-in-up delay-100">
        <Button
          onClick={handleStart}
